...
* @{
*/
#define PRODUCT_KEY "155483f5db6c47cab70831cc21899c9c"
/**@} */
/**@name Product Secret (Product key)
* @{
*/
#define PRODUCT_SECRET "927db94401cc4fcf991d3e1c43fbb0fb"
...
* @{
*/
#define power_BYTEOFFSET                    0
#define power_BITOFFSET                     0
#define power_LEN                           1
...
typedef enum
{
    LED_Color_VALUE0 = 0,//黄色
    LED_Color_VALUE1 = 1,//紫色
    LED_Color_VALUE2 = 2,//粉色
	 LED_Color_VALUE3 = 3,//自定义
    LED_Color_VALUE_MAX,
} LED_Color_ENUM_T;
